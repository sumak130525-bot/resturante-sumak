      ...
      <div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => setEditItem({ id: '', category_id: categories[0]?.id ?? '', name: '', description: null, name_en: null, name_qu: null, description_es: null, description_en: null, description_qu: null, price: 0, image_url: null, available: 0, available_qty: null, active: true, created_at: '' })}
